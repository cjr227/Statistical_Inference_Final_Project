...
The AIC value of this model is `r AIC(one_way.fit)`, and the BIC value of this model is `r BIC(one_way.fit)`.
...
The AIC value of this model is `r AIC(two_way.fit)`, and the BIC value of this model is `r BIC(two_way.fit)`.
